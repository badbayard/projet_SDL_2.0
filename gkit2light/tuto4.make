...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto4
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto4.exe
...
$(OBJDIR)/tuto4.o: tutos/tuto4.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
