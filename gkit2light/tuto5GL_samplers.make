...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto5GL_samplers
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto5GL_samplers.exe
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tuto5GL_samplers
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto5GL_samplers.exe
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/tuto5GL_samplers
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto5GL_samplers.exe
  DEFINES   += -DDEBUG -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tuto5GL_samplers
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto5GL_samplers.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I. -Isrc/gKit -Iextern/mingw/include
