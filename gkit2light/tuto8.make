...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto8
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto8.exe
...
$(OBJDIR)/tuto8.o: tutos/tuto8.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
