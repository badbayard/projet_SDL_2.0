...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto3GL_reflect
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto3GL_reflect.exe
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tuto3GL_reflect
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto3GL_reflect.exe
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/tuto3GL_reflect
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto3GL_reflect.exe
  DEFINES   += -DDEBUG -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tuto3GL_reflect
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto3GL_reflect.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I. -Isrc/gKit -Iextern/mingw/include
...
$(OBJDIR)/tuto3GL_reflect.o: tutos/tuto3GL_reflect.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
