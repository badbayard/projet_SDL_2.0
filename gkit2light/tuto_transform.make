...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto_transform
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_transform.exe
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tuto_transform
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_transform.exe
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/tuto_transform
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_transform.exe
  DEFINES   += -DDEBUG -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tuto_transform
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_transform.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I. -Isrc/gKit -Iextern/mingw/include
...
$(OBJDIR)/tuto_transform.o: tutos/tuto_transform.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
