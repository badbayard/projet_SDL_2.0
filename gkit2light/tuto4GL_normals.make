...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto4GL_normals
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto4GL_normals.exe
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tuto4GL_normals
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto4GL_normals.exe
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/tuto4GL_normals
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto4GL_normals.exe
  DEFINES   += -DDEBUG -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tuto4GL_normals
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto4GL_normals.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I. -Isrc/gKit -Iextern/mingw/include
...
$(OBJDIR)/tuto4GL_normals.o: tutos/tuto4GL_normals.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
