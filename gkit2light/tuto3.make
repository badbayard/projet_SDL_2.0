...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto3
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto3.exe
...
$(OBJDIR)/tuto3.o: tutos/tuto3.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
